...
#define HZK12_ADDR (0x8100000 + 0x0)		/* 12点阵汉字库地址 */
#define HZK16_ADDR (0x8100000 + 0x2C9D0)	/* 16点阵汉字库地址 */
#define HZK24_ADDR (0x8100000 + 0x68190)	/* 24点阵汉字库地址 */
#define HZK32_ADDR (0x8100000 + 0xEDF00)	/* 32点阵汉字库地址 */
